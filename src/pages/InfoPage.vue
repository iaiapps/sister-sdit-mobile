  ...
  <div class="page-info">
    ...
    <div class="content px-3">
      <div class="info-card">
        ...
        <p>
          <b>Aplikasi Sister Mobile SDIT Harum</b> Sistem Informasi Terpadu
          sekaligus Aplikasi Presensi di lingkungan SDIT Harapan Umat Jember
        </p>
        <p>
          <a
...
const send = () => {
  window.cordova.InAppBrowser.open(
    "whatsapp://send?phone=6285232213939",
    "_system",
  );
};
const timer = () => {
