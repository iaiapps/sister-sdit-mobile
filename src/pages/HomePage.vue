  ...
  <div>
    ...
    <div class="app-bar">
      <div class="app-bar-left">
        <img src="@/assets/img/logo.svg" alt="logo" class="logo-sm" />
        <h2>SISTER</h2>
      </div>
    ...
    <div class="content px-3">
      ...
      <div class="greeting-card">
        ...
        <div v-if="viewK" class="gps-info">
          ...
          <div class="radius-labels">
            <span>0 m</span><span>{{ props.localData.radius || 100 }} m</span>
          </div>
        </div>
      ...
      <div class="scan-card">
        <div
          class="scan-icon d-flex align-items-center justify-content-center flex-shrink-0"
        >
          <svg
            width="36"
            height="36"
...
const getK = () => {
  ...
  const onSuccess = (position) => {
    ...
    const centerPoint = {
      lat: props.localData.latitude,
      lng: props.localData.longitude,
    };
...
const postSelectedItem = () => {
  ...
  if (
    (selected.value === "Tugas kedinasan" ||
      selected.value === "Pulang awal") &&
    !catatan.value
  ) {
